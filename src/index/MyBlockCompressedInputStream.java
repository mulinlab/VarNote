...
public final class MyBlockCompressedInputStream extends InputStream implements LocationAware {
     ...
     */
    public MyBlockCompressedInputStream(final SeekableStream strm) {
        this(strm, new IntelInflaterFactory());
    }
     ...
     */
    public MyBlockCompressedInputStream(final SeekableStream strm, final InflaterFactory inflaterFactory) {
        mFile = strm;
        mStream = null;
