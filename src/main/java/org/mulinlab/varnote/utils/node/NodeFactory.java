...
public final class NodeFactory {
	...
	public static void ajustEND(final String alt, LocFeature intv) {
...
//        }
	...
	public static void ajustSVTYPE(final String info, LocFeature intv) {
//		if(info == null) return;
//		ajustEND(info, intv);
...
//		}
	...
	public static LocFeature createBasic(final String s, final Format queryFormat, LocFeature intv, ByteArrayOutputStream buf) {
//		int col = 0, flag = 0;
//		try {
//			intv.clear();
//			char c;
...
//		LocFeature node = new LocFeature();
