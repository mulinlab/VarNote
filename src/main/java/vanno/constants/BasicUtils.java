...
//	public static final int[] bins = new int[MAX_BINS];
	...
	public final static Log DEFAULT_LOG = new Log(false, false);
	...
	public final static Output DEFAULT_OUTPUT = null;
	...
	public final static boolean DEFAULT_DISPLAY_LABEL = false;
	public final static IntersectType DEFAULT_INTERSECT = IntersectType.OVERLAP;
	...
	public final static String DEFAULT_ANNO_CONFIG = null;
	public final static String DEFAULT_ANNO_OUT = null;
	public final static String DEFAULT_VCF_FOR_BED = null;
	public final static AnnoOutFormat DEFAULT_ANNO_OUT_FORMAT = null; 
