...
import main.java.vanno.bean.config.config.FormatReadConfig;
import main.java.vanno.bean.config.config.VcfInfoReadConfig;
import main.java.vanno.bean.format.BEDHeaderParser;
import main.java.vanno.bean.format.Format;
import main.java.vanno.bean.format.Format.H_FIELD;
	...
	public void setDBPath(final String dbPath, final boolean isVCF, final boolean isOutVCF) {
		...
		if(!isVCF && isOutVCF) {
			...
			if(fieldVcfInfoPath != null) {
				vcfInfoMaps = (new VcfInfoReadConfig<Map<String, VCFInfoHeaderLine>>()).read(fieldVcfInfoPath);	
		...
		if(fieldsFormatPath != null) {
			fieldFormatMaps = (new FormatReadConfig<Map<String,FieldFormat>>()).read(fieldsFormatPath);	
