 ...
 */
public class MyBlockCompressedOutputStream
        extends OutputStream
        implements LocationAware
{

    private static final Log log = Log.getInstance(MyBlockCompressedOutputStream.class);
     ...
     */
    public MyBlockCompressedOutputStream(final String filename) {
     ...
     * Use {@link #BlockCompressedOutputStream(File, int, DeflaterFactory)} to specify a custom factory.
     */
    public MyBlockCompressedOutputStream(final File file) {
     ...
     * @param compressionLevel 1 <= compressionLevel <= 9
     */
    public MyBlockCompressedOutputStream(final String filename, final int compressionLevel) {
     ...
     * Use {@link #BlockCompressedOutputStream(File, int, DeflaterFactory)} to specify a custom factory.
     */
    public MyBlockCompressedOutputStream(final File file, final int compressionLevel) {
     ...
     */
    public MyBlockCompressedOutputStream(final File file, final int compressionLevel, final DeflaterFactory deflaterFactory) {
        this.file = file;
     ...
     */
    public MyBlockCompressedOutputStream(final OutputStream os, final File file) {
     ...
     * Use {@link #BlockCompressedOutputStream(OutputStream, File, int, DeflaterFactory)} to specify a custom factory.
     */
    public MyBlockCompressedOutputStream(final OutputStream os, final File file, final int compressionLevel) {
     ...
     * @param deflaterFactory custom factory to create deflaters (overrides the default)
     */
    public MyBlockCompressedOutputStream(final OutputStream os, final File file, final int compressionLevel, final DeflaterFactory deflaterFactory) {
        this.file = file;
     ...
     *         is a BCOS.
     */
    public static MyBlockCompressedOutputStream maybeBgzfWrapOutputStream(final File location, OutputStream output) {
        if (!(output instanceof MyBlockCompressedOutputStream)) {
           return new MyBlockCompressedOutputStream(output, location);
        } else {
           return (MyBlockCompressedOutputStream)output;
        }
    }
